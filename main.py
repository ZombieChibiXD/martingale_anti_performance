...
STARTING_FUNDS = 0
ITERATION = 100
FUND_INCREMENT_ITERATION = 10
# Starting bet is 0.005 % of your starting funds
MARTINGALE_STARTING_BET = 2 # STARTING_FUNDS * 5 // (100000)
ANTI_MARTINGALE_STARTING_BET = 5 # STARTING_FUNDS * 100 // (100000)
...
print("Saving Funds: %.2f" % SAVING_FUNDS)
